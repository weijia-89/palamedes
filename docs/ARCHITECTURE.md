...
Single repo, four user-facing surfaces, one epistemic methodology. Canonical skill body: [`skill/SKILL.md`](../skill/SKILL.md) (**v3.13.0**).
...
P1.5 Decompose → MECE split + citation markers when the question has multiple sub-questions
P2 Retrieve  → RETRIEVAL-ORDER log, read-depth, DEAI-IN; lossless condensation; anti-no-op nudge
P3 Adversarial → protocol conformance, anti-no-op continuation, steelman, bias scan, llm-failure-modes
