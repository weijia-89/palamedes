...
| **T1 (independent testing)** | Member-funded consumer testing programs that meet or exceed the EU regulatory floor: ADAC (Germany), Stiftung Warentest (Germany), TCS (Switzerland), Mozilla *Privacy Not Included (international, for connected products), Mamavation XRF (for chemical contamination detection) |
...
| **T3 (flagged for affiliate / blog-format)** | Lucie's List, SafeWise, Forbes Personal Shopper, Mother.ly, etc. — use only for category framing |
...
- **+++** Source-T1 testing (ADAC, Mozilla *PNI, Mamavation, EU-standard-certified): large positive weight; promoted to top of use case
...
- **—** T1-failed (e.g., ADAC "poor" or PFAS chemical fail; Mozilla *PNI "Yikes"; Mamavation lead-positive): hard disqualify
