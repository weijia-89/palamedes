...
- Corpus pages: every heading id (auto-generated by `markdown-it-anchors`) is implicitly a notable anchor; the BE accepts any `^[a-z0-9-]+$` anchor and routes to `CC_Study_Guide.md`
