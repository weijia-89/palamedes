...
- `study-guide-site`: markdown outline aligned with `skill/references/study-guide-site.md` (browseable HTML site is a downstream render; this UI pass ships the corpus + cadence plan only). Sections:
  ...
  - **Inline memory anchors** — elicitation blockquote stubs at each Part heading (learner picks room/loci/images; see Appendix D.2).
